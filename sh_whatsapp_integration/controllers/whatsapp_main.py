...
class DownloadReport(http.Controller):
    ...
    def _show_report(self, model, report_type, report_ref, download=False):
        ...
        if not isinstance(ReportAction, type(request.env['ir.actions.report'])):
            raise UserError(
    ...
    # Download Stock Delivery Order Report
    ...
    # Download Account Payment Report

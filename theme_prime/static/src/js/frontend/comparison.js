...
publicWidget.registry.ProductComparison.include(Object.assign({}, B2bMixin, {
    ...
    start: function () {
        ...
        // Right now we are calling super if #wrap contains .tp-droggol-builder-snippet
        // For V15 we only call super if wishlist feature is enabled for snippet.

        // var comparisonEnabled = false;
        // var $snippets = this.$('.tp-droggol-builder-snippet[data-user-params]');
        ...
        //     }
        // });
        if (this.$('.tp-droggol-builder-snippet').length || this.$target.hasClass('oe_website_sale') || this.$('.oe_website_sale').length) {

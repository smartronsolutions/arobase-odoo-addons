...
class KsWooCommerceConnectorInstance(models.Model):
    ...
    # Auto Job Crons:
    ks_aip_cron_id = fields.Many2one('ir.cron', readonly=True, string="AIP Cron")
    ks_aio_cron_id = fields.Many2one('ir.cron', readonly=True, string = "AIO Cron")
    ks_auos_cron_id = fields.Many2one('ir.cron', readonly=True, string = "AUOS Cron")
    ks_aus_cron_id = fields.Many2one('ir.cron', readonly=True, string = "AUS Cron")
    ks_aeps_cron_id = fields.Many2one('ir.cron', readonly=True, string = "AEPS Cron")
    ks_aps_cron_id = fields.Many2one('ir.cron', readonly=True, string="Product Auto Sync Cron")
    ks_acs_cron_id = fields.Many2one('ir.cron', readonly=True, string="Customer Auto Sync Cron")
    ks_aep_cron_id = fields.Many2one('ir.cron', readonly=True, string="Auto Export Of New Products")
    ks_ausp_cron_id = fields.Many2one('ir.cron', readonly=True, string="Auto Update of Synced Products")
    ks_uwsw_cron_id = fields.Many2one('ir.cron', readonly=True, string = "Update Woo Saleorder Workflow Cron")
